...
const { createQuizTestCategory,
    UpdateQuizTestCategory,
    getAllQuizTestCategory,
    deleteQuizTestCategory,CreatQuiz,UpdateQuiz,getAllQuiz,getSingleQuizQuestions,getSingleQuiz,deleteQuiz,CreateQuizQuestions,deleteQuizQuestion,UpdateQuizQuestion}=require("../../controller/admin/quizController")
//Quiz
...
router.get("/quiztest/category",isAdmin,getAllQuizTestCategory);
